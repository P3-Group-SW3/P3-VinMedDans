...
/*
 * Alternating layout of text and images.
 * Parameter 'items' should be an array of objects with at least three fields;
 * title, description and imageURL.
 */
        ...
        <div className="container my-5">
            {items.map((item, index) => (
                <div className="row align-items-center justify-content-center mb-4 mx-auto fit-content" key={index} style={{backgroundColor: item.title ? "#FFFFFF" : "#FFFAED"}}>
                    {/* Image is order-1 on even-numbered indices, order-2 on odd-numbered indices */}
                    ...
                    {/* Text is order-2 on even-numbered indices, order-1 on odd-numbered indices */}
                    <div className={`col-lg-6 ${index % 2 === 0 ? "order-lg-2" : "order-lg-1"} text-center text-lg-start`}>
                        ...
                        {/* If item has stuck, it is a wine on the product page, and it should have a CartModify */}
