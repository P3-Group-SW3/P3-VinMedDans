            ...
            <div className="container py-5">
                <div className="card shadow-sm">
                    ...
                    <div className="d-flex flex-column align-items-center">
                        <h2 className="card-title">Ordre Oversigt</h2>
                        <p className="card-text">Ordre ID: {order.id}</p>
                        <p className="card-text">Du modtager en mail om et øjeblik, når betalingen er bekræftet.</p>
                        <div className="mb-4">
                            <StateCircles
                                state={message}
                                customStateNames={{
