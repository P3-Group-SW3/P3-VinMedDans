...
public class TestOrderLineService {
    ...
    public void canBePurchased03() {
        ...
        when(wine1.canBePurchased(anyInt()))
                .thenReturn(true);
        when(wine2.canBePurchased(anyInt()))
                .thenReturn(false);

        OrderLineCannotBePurchased newException = assertThrows(OrderLineCannotBePurchased.class, ()-> {
