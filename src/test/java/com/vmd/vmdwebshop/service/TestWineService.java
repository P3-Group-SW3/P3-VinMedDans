...
public class TestWineService {
    ...
    // Testing on createAndEditWine method

    @Test
    public void TestCreateAndEditWine01() {
        when(wineRepository.findById(Long.parseLong("99")))
                .thenThrow( new DataAccessException(""){});

        WineDataAccessException newException = assertThrows(WineDataAccessException.class, () -> {
            wineService.createAndEdit(wine1, Long.parseLong("99"));
        });
    ...
    // Testing on deleteWine method

    @Test
    public void TestDeleteWine() {
        when(wineRepository.findById(Long.parseLong("1")))
                .thenReturn(Optional.empty());

        WineNotFoundException newException = assertThrows(WineNotFoundException.class, ()-> {
            wineService.delete(Long.parseLong("1"));
        });
    ...
    public void TestGetWineByID01() {
        ...
        WineNotFoundException newException = assertThrows(WineNotFoundException.class, ()-> {
            wineService.getWineById(Long.parseLong("1"));
        });
    ...
    public void TestGetWineByID02() {
        when(wineRepository.findById(Long.parseLong("1")))
                .thenReturn(Optional.ofNullable(wine1));
    ...
    // Testing on setActiveState method
    ...
    public void TestSetActiveState02() {
        ...
        WineDataAccessException newException = assertThrows(WineDataAccessException.class, ()-> {
            wineService.changeActiveState("1");
        });
    }

    // Testing on canBePurchased method
    ...
    // Testing on updateStockFromOrder method
    ...
    public void TestUpdateStockFromOrder01() {
        ...
        when(wineRepository.getById(Long.parseLong("1")))
                .thenReturn(wine1);
        when(wineRepository.getById(Long.parseLong("2")))
                .thenReturn(wine2);
    ...
    public void TestUpdateStockFromOrder03() {
        ...
        when(wineRepository.getById(Long.parseLong("2")))
                .thenReturn(wine2);
        when(wineRepository.save(wine1))
                .thenThrow(new DataIntegrityViolationException(""){});

        WineNotUpdatedException newException = assertThrows(WineNotUpdatedException.class, ()-> {
            wineService.updateStockFromOrder(newOrderLineList);
        });
